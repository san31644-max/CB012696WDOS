...
// Add click event to toggle the visibility of the menu
...
function placeOrder() {
    ...
    successMessage.innerHTML = 'Your order will be placed within 24 hours.';
    
    // Append the message to the body (or any other section of your page)
    document.body.appendChild(successMessage);
    
    // Optionally, you can add a timeout to remove the message after a few seconds
    setTimeout(function() {
